...
// Copyright (c) 2015-2019 The UtopiaCoinOrg developers
...
var (
	defaultHomeDir        = ucutil.AppDataDir("politeiavoter", false)
...
func loadConfig() (*config, []string, error) {
	...
	if cfg.PoliteiaWWW == "" {
		if activeNetParams.Name == "mainnet" {
			cfg.PoliteiaWWW = "https://proposals.UtopiaCoinOrg.org/api"
		} else {
			cfg.PoliteiaWWW = "https://test-proposals.UtopiaCoinOrg.org/api"
		}
	}
