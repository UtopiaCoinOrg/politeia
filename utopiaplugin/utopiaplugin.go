...
type StartVote struct {
	// UtopiaCoinOrg plugin only data
	Version uint `json:"version"` // Version of this structure
...
type Comment struct {
	...
	// Metadata generated by UtopiaCoinOrg plugin
...
// NewCommentReply returns the metadata generated by UtopiaCoinOrg plugin for the new
// comment.
...
// Inventory is used to retrieve the UtopiaCoinOrg plugin inventory.
...
// InventoryReply returns the UtopiaCoinOrg plugin inventory.
