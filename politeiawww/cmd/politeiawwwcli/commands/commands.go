...
import (
	...
	v1 "github.com/UtopiaCoinOrg/politeia/politeiawww/api/www/v1"
	wwwclient "github.com/UtopiaCoinOrg/politeia/politeiawww/cmd/politeiawwwcli/client"
...
type Cmds struct {
	...
	SendFaucetTx        SendFaucetTxCmd        `command:"sendfaucettx" description:"         send a UC transaction using the UtopiaCoinOrg testnet faucet"`
