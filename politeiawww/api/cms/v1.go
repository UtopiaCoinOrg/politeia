...
type InvoiceInput struct {
	...
	PaymentAddress     string           `json:"paymentaddress"`     //  UC payment address
...
type Payout struct {
	...
	UCTotal       ucutil.Amount `json:"uctotal"`     // in UC atoms
...
type PaymentInformation struct {
	...
	AmountNeeded    ucutil.Amount `json:"amountneeded"`
	AmountReceived  ucutil.Amount `json:"amountreceived"`
