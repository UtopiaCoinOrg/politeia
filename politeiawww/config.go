...
import (
	...
	"github.com/UtopiaCoinOrg/politeia/politeiawww/sharedconfig"
...
type config struct {
	...
	PaywallAmount            uint64 `long:"paywallamount" description:"Amount of UC (in atoms) required for a user to register or submit a proposal."`
