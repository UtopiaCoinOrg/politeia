...
You are invited to join UtopiaCoinOrg as a contractor! To complete your registration, you will need to use the following link and register on the CMS site:

{{.Link}}

You are receiving this email because {{.Email}} was used to be invited to UtopiaCoinOrg's Contractor Management System.
...
An administrator has submitted a new comment to your invoice, please login to cms.UtopiaCoinOrg.org to view the message.
`

const templateNewInvoiceStatusUpdateRaw = `
An invoice's status has been updated, please login to cms.UtopiaCoinOrg.org to review the changes.
