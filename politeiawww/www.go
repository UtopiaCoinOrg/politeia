...
import (
	...
	cachedb "github.com/UtopiaCoinOrg/politeia/politeiad/cache/cockroachdb"
	cms "github.com/UtopiaCoinOrg/politeia/politeiawww/api/cms/v1"
	www "github.com/UtopiaCoinOrg/politeia/politeiawww/api/www/v1"
	cmsdb "github.com/UtopiaCoinOrg/politeia/politeiawww/cmsdatabase/cockroachdb"
	"github.com/UtopiaCoinOrg/politeia/politeiawww/user"
	userdb "github.com/UtopiaCoinOrg/politeia/politeiawww/user/cockroachdb"
	"github.com/UtopiaCoinOrg/politeia/politeiawww/user/localdb"
...
func _main() error {
	...
	if loadedCfg.PaywallAmount != 0 && loadedCfg.PaywallXpub != "" {
		paywallAmountInUc := float64(loadedCfg.PaywallAmount) / 1e8
		log.Infof("Paywall : %v UC", paywallAmountInUc)
	...
	case cmsWWWMode:
		...
		ws, err := newWSUcdata()
		if err != nil {
			return fmt.Errorf("new wsUcdata: %v", err)
		}
		p.wsUcdata = ws
	...
	// Shutdown all ucdata websockets
	if p.wsUcdata != nil {
		p.wsUcdata.client.Stop()
	}
