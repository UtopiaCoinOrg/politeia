...
import (
	...
	uctime "github.com/UtopiaCoinOrg/uctime/api/v1"
...
// DataAnchor describes what is stored in uctime. We store the SHA256 hash of
// STH.LogRoot in uctime
type DataAnchor struct {
	...
	VerifyDigest uctime.VerifyDigest   `json:"verifydigest"` // uctime digest structure
}
...
type RecordEntryProof struct {
	...
	Anchor      *uctime.ChainInformation `json:"anchor,omitempty"`      // Anchor info for STH
