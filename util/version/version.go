...
// Copyright (c) 2015-2018 The UtopiaCoinOrg developers
...
var (
	...
	// build process with:
	// '-ldflags "-X github.com/UtopiaCoinOrg/politeia/util/version.PreRelease=foo"'
	...
	// build process with:
	// '-ldflags "-X github.com/UtopiaCoinOrg/politeia/util/version.BuildMetadata=foo"'
