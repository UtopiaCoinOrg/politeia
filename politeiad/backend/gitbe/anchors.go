...
// merkle root, that get checkpointed in uctime. This provides censorship
...
// have not been checkpointed in uctime yet. To identify these, we parse the
...
// LastAnchor stores the last commit anchored in uctime.
